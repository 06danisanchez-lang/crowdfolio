...
export const translations: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    'hero.subheadline': 'Centralize your investments, visualize your portfolio, and get a unified tax report from a single dashboard.',
    'hero.bullet1': 'Centralize your investments in a single dashboard',
    'hero.bullet2': 'Visualize your portfolio with a clear overall view',
