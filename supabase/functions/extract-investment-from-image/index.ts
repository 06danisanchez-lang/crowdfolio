...
const SYSTEM_PROMPT = `Eres un experto en plataformas de crowdfunding inmobiliario españolas. Analiza la imagen proporcionada y extrae los datos de la inversión.
...
- amount: cantidad invertida en euros (solo el número, sin símbolo €)
